...
describe('totalLikes', () => {
  ...
  test('should return number of likes of a blog if array has only one blog', () => {
    expect(listHelper.totalLikes(listWithOneBlog)).toBe(5)
  })

  test('should return total likes of all blogs in array', () => {
...
describe('favoriteBlog', () => {
  ...
  test('should return the only blog if array has only one blog', () => {
